...
def get_user_shopping_session_data(request):
    ...
    for cart_item in cart_items:
        ...
        if product:
            ...
            cart_item_data.append({
                ...
                "cargo_data": cargo_data or "Not any cargo fee",
                'product': {
                    'id': product.id,
                    'name': product.name,
    ...
    amount_to_be_paid -= whole_discounts
    amount_to_be_paid += whole_cargo_fee

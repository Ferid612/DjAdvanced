...
from DjApp.managements.tokens import generate_new_access_token 
...
def send_verification_code(person_id, person_email):
    ...
    try:
        ...
        token_with_url = str(HOST_URL) + '/get_verification/?access_token=' + str(verification_token) + '&person_id=' + str(person_id)

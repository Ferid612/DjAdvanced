...
urlpatterns = [
    ...
    # MANAGMENT WISHLIST
    path('create-wishlist/', WishlistController.create_wishlist, name="create-wishlist"),    
    path('update-wishlist-title/<int:wishlist_id>/', WishlistController.update_wishlist_title, name="update-wishlist_title"),    
    path('delete-wishlist/<int:wishlist_id>/', WishlistController.delete_wishlist, name="delete-wishlist"),    

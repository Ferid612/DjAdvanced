...
urlpatterns = [
    ...
    # Product URLs  +++++
    path('products/create/', ProductController.create_product_template,
         name='create_product_template'),
    path('products/create-entry/', ProductController.create_product_entry,
         name='create_product_entry'),
    path('products/<int:product_id>/update/',
         ProductController.update_product, name="update_product"),
    path('products/<int:product_id>/delete/',
         ProductController.delete_product, name="delete_product"),

    path('product-entries/<int:entry_id>/update/',
         ProductController.update_product_entry, name="update-product-entry"),
    path('product-entry/<int:entry_id>/delete/',
         ProductController.delete_product_entry, name="delete-product-entry"),
    path('product-entry/update-all/',
         ProductController.update_all_product_entries, name="update-all-entries"),


    # Product image URLs +++++
    path('images/<int:entry_id>/add/',
         ProductImageController.add_product_image, name="add_product_image"),
    path('images/add-all/', ProductImageController.add_image_to_all_product_entries,
         name="add-image-all-product"),
    path('images/<int:image_id>/update/',
         ProductImageController.update_product_image, name="update_product_image"),
    path('images/<int:image_id>/delete/',
         ProductImageController.delete_product_image, name="delete_product_image"),


    # Properties URLs
    path('product-properties/', views_product.get_product_properties,
         name='product-properties'),

    # Measures URLs
    path('measures/add-measure/', MeasureController.add_measure, name="add-measure"),
    path('measures/<int:measure_id>/values/add/',
         MeasureController.add_measure_values, name="add_measure_value"),
    ...
    path('materials/add-material/',
         MaterialController.add_material, name="add-material"),
    ...
    path('tags/add-to-entry/<int:entry_id>',
         TagController.add_tag_to_product_entry, name="add-tag-to-product-entry"),
    path('tags/delete-from-entry/<int:entry_id>',
         TagController.delete_tag_from_product_entry, name="delete-tag-from-product-entry"),



    # MANAGMENT TABLES
    path('tables/delete-null-category_products/',
         CategoryController.delete_null_category_products, name="delete-null-category_products"),

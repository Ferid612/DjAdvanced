...
urlpatterns = [
    ...
    path('update-cart-item-status/', ShoppingController.update_cart_item_status, name="update-cart-item-status"),    
    path('delete-from-basket/<int:cart_item_id>', ShoppingController.delete_cart_item, name="delete-from-basket"),    
    
    path('complete-order/', OrderController.CompleteOrder, name="complete-order"),    
]